...
@section('content')
    ...
    <div class="modal fade" id="ajouterMembreModal" tabindex="-1" aria-labelledby="ajouterMembreModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg"> <!-- taille de la modale -->
    ...
    <div style="text-align: end">
        <a href="{{ route('collaborateurs.create') }}" class="btn btn-success" style="margin-top: 20px; width: 21%; height: 45px; border-radius: 10px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Ajouter un collaborateur</a>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="NomFr" class="form-control" value="{{ old('NomFr') }}" required>
    </div>
    <div class="form-group">
